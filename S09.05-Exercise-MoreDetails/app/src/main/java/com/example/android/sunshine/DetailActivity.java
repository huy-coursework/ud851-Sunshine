...
public class DetailActivity extends AppCompatActivity
    ...
    private static final int INDEX_PRESSURE = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mUri == null) {
            throw new NullPointerException("Provided URI was null");
        }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == WEATHER_LOADER_ID) {
            ...
            throw new UnsupportedOperationException("Loader not implemented for ID: " + id);
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mDate.setText(
                SunshineDateUtils.getFriendlyDateString(this, data.getLong(INDEX_DATE), false));
        mDescription.setText(
                SunshineWeatherUtils.getStringForWeatherCondition(
                        this,
                        data.getInt(INDEX_WEATHER_ID)));
        mHigh.setText(
                SunshineWeatherUtils.formatTemperature(this, data.getDouble(INDEX_MAX_TEMP)));
        mLow.setText(
                SunshineWeatherUtils.formatTemperature(this, data.getDouble(INDEX_MIN_TEMP)));
        mHumidity.setText(getString(R.string.format_humidity, data.getFloat(INDEX_HUMIDITY)));
        mWind.setText(
                SunshineWeatherUtils.getFormattedWind(
                        this,
                        data.getFloat(INDEX_WIND_SPEED),
                        data.getFloat(INDEX_DEGREES)));
        mPressure.setText(getString(R.string.format_pressure, data.getFloat(INDEX_PRESSURE)));
        mForecastSummary = String.format(
                "%s - %s - %s / %s",
                SunshineDateUtils.getFriendlyDateString(this, data.getLong(INDEX_DATE), false),
                SunshineWeatherUtils.getStringForWeatherCondition(
                        this,
