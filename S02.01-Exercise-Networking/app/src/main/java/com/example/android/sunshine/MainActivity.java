...
public class MainActivity extends AppCompatActivity {
    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... locations)
        {
            ...
            try {
                String forecastJsonStr = NetworkUtils.getResponseFromHttpUrl(url);
                response = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(
                        MainActivity.this,
                        forecastJsonStr);
            }
            catch (Exception e) {
