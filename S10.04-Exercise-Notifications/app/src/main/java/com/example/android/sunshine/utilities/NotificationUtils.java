...
public class NotificationUtils {
    ...
    private static final int WEATHER_SYNC_PENDING_INTENT_ID = 931114;
    private static final int WEATHER_SYNC_NOTIFICATION_ID = 334711312;
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            PendingIntent detailActivityPendingIntent =
                    taskStackBuilder.getPendingIntent(
                            WEATHER_SYNC_PENDING_INTENT_ID,
