...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String humidityStringA11y = getString(R.string.a11y_humidity, humidityString);

        /* Set the text to display the humidity */
        mDetailBinding.extraDetails.humidity.setText(humidityString);
        mDetailBinding.extraDetails.humidity.setContentDescription(humidityStringA11y);
        ...
        mDetailBinding.extraDetails.wind.setContentDescription(windStringA11y);
        ...
        mDetailBinding.extraDetails.pressure.setContentDescription(pressureStringA11y);
